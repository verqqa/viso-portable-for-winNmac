...
SETTINGS_LAYOUT_DATA: Any = {  # noqa: F811
    ...
    "Background Settings": {
        "WebcamBackgroundEnableToggle": {
            "level": 1,
            "label": "Enable Background Replacement",
            "default": False,
            "help": "Remove the background of the live webcam feed or video frame and replace it with a background image.",
        },
        "WebcamBackgroundTypeSelection": {
            "level": 2,
            "label": "Replacement Method",
            "options": ["Chroma Key (Green/Blue Screen)"],
            "default": "Chroma Key (Green/Blue Screen)",
            "parentToggle": "WebcamBackgroundEnableToggle",
            "requiredToggleValue": True,
            "help": "Choose the method to identify the background to remove.",
        },
        "WebcamChromaKeyColorSelection": {
            "level": 3,
            "label": "Key Color Type",
            "options": ["Green", "Blue", "Custom Hex"],
            "default": "Green",
            "parentToggle": "WebcamBackgroundEnableToggle",
            "requiredToggleValue": True,
            "help": "Select green screen, blue screen, or a custom color hex.",
        },
        "WebcamChromaKeyColorHexText": {
            "level": 4,
            ...
            "parentToggle": "WebcamBackgroundEnableToggle",
            "requiredToggleValue": True,
            "parentSelection": "WebcamChromaKeyColorSelection",
            "requiredSelectionValue": "Custom Hex",
            "help": "Enter custom color hex code (e.g. #00FF00). Press Enter to apply.",
        },
        "WebcamChromaKeyToleranceSlider": {
            "level": 3,
            ...
            "parentToggle": "WebcamBackgroundEnableToggle",
            "requiredToggleValue": True,
            "help": "Adjust how closely the color must match the key color to be removed.",
        },
        "WebcamChromaKeyFeatherSlider": {
            "level": 3,
            ...
            "parentToggle": "WebcamBackgroundEnableToggle",
            "requiredToggleValue": True,
            "help": "Applies a blur to the mask edges to blend the subject smoothly with the new background.",
        },
        "WebcamBackgroundImagePathText": {
            "level": 2,
            ...
            "parentToggle": "WebcamBackgroundEnableToggle",
            "requiredToggleValue": True,
            "help": "Enter the full path to a background image (.jpg or .png) and press Enter.",
        },
    },
    "Misc": {
